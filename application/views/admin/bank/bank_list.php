<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/bank/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/bank/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_rekening",
                            "orderable": false
                        },{"data": "nama_bank"},{"data": "atas_nama"},{"data": "nomor"},
                        {
                            "data" : "action",
                            "orderable": false,
